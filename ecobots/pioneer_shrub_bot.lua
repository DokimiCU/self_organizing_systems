...
-- for check randpos is below air side another bot
	...
	local randpos_ranside = {x = randpos.x + math.random(-1,1), y = randpos.y + math.random(-1,0), z = randpos.z + math.random(-1,1)}
...
if  light_level >= 14 and (num_bot) < poplim then
	...
	minetest.get_node(randpos_ranside).name == "ecobots:ecobots_pioneer_shrub_bot" then
